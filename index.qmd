...
pages. We use [ObservableHQ](https://observablehq.com)'s runtime to
provide a variant of Javascript, which includes "reactive"
variables. This means that you can write and run Javascript inside
Quarto cells, with additional support for features which make building
dashboards particularly easy.
...
We are using two OJS features here. The first feature is that
...
This is only the beginning of what's possible with OJS and
...
[^clicked-global]: In this example, you might be tempted to write
    ...
    OJS are not injected into the global Javascript namespace, 
